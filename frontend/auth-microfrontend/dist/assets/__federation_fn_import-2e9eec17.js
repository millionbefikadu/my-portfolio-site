...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-57f88920.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-2a1d98d5.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'@apollo/client':{get:()=>()=>__federation_import(new URL('__federation_shared_@apollo/client-d1c018ff.js', import.meta.url).href),import:true,requiredVersion:'^3.0.0'}};
